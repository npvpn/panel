...
XRAY_HEALTH_CHECK_STARTUP_DELAY = config("XRAY_HEALTH_CHECK_STARTUP_DELAY", cast=int, default=120)
...
XRAY_NODE_REST_START_TIMEOUT = config("XRAY_NODE_REST_START_TIMEOUT", cast=int, default=90)
XRAY_NODE_REST_RESTART_TIMEOUT = config("XRAY_NODE_REST_RESTART_TIMEOUT", cast=int, default=90)
